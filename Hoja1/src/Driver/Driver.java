...
public class Driver {
    ...
    public static void main(String[] args) { //
        ...
        Radio Alejuadiela = new RadioCarro(); //----------------------------LINEA A CAMBIAR POR EL AUXILIAR
        ...
        while (funcionamiento==0){
                ...
                while (ingreso==1){
                    while (true){
                        ...
                        if (banda==1){
                            ...
                            System.out.println("Por favor ingrese una opcion del menu valida.");
                        }
                    }
                    if (ingreso==1){
            ...
            else { //Si se ingresa algo que no esta en el menu
                System.out.println("Por favor ingrese una opcion del menu valida.");
            }
